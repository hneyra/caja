...
/**
 * Lo que `caja` declara de si mismo a las barreras de {@code comun-verificaciones}.
 *
...
public final class ConfiguracionDeCaja implements ConfiguracionDeLasVerificaciones {
     ...
     *
     * <p>La regla {@code NINGUN_SQL_CRUZA_LA_FRONTERA_DE_caja} necesita saber de quien es la
    ...
    public Set<String> paquetesQueTienenQueExistir() {
        return Set.of("kamayuk.caja.esquema");
    }
