...
public class ReciboController {
     ...
     * pequenas.
     */
    @GetMapping(value = "/recibos/{nro}/duplicado", params = "formato")
    ...
    /**
     * Anula el cobro del dia (RF-083, ADR-0026 §4).
     *
     * <p><b>Vive bajo {@code /cobros} y no bajo {@code /recibos}</b>, que es donde estaba en el
     * monolito. El recurso que se anula es el COBRO —el acto— y no el papel: el papel es su
     * constancia, y el numero impreso es lo unico que la ventanilla conoce para nombrarlo. Es la
     * ruta que ADR-0026 fija para esta frontera.
     *
     * <p>Y ya <b>no devuelve la deuda al libro</b>: eso lo hace el sistema que emitio la orden al
     * recibir el {@code PagoAnulado}, reversando —nunca borrando—. Aqui lo que pasa es que la orden
     * vuelve a PENDIENTE y el evento sale al buzon en la misma transaccion que el acta.
     */
    @PostMapping("/cobros/{nro}/anulacion")
