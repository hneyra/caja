...
import kamayuk.caja.caja.dominio.RecaudacionRepository;
 ...
 *       rango, hermana de {@link kamayuk.caja.cuentacorriente.ConciliacionDeCaja}—, y no se escribe
...
public class ConsultaDeRecaudacion {
    ...
    public record Avance(
         ...
         * hay ningun {@link kamayuk.caja.dominio.PuntoDeRedondeo} que aplicar aqui, y aplicar uno
