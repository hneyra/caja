...
public final class MotorPostgres implements AutoCloseable {
     ...
     * modulo de caja caen en las clases del contexto con ESTE mensaje; quitando ademas esta guarda
     * —el estado anterior a #706— quedan 5 rojos, todos en {@code BusquedaDelCatalogoVialTest} y
     * todos diciendo «requested character too large for encoding: 1114111», con los otros 412 en
     * verde.
     *
     * <p>Treinta rojos claros por cinco confusos es el cambio que se quiso: <b>no</b> se puede
     * evitar que sean pruebas del negocio las que se pongan rojas, porque el motor lo resuelve cada
