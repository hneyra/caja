// kamayuk-caja-esquema no es un contexto acotado: contiene las migraciones Flyway, el
...
// reutiliza kamayuk-caja-plataforma para su prueba con el pool real. Un segundo arranque
...
application {
    mainClass.set("kamayuk.caja.esquema.Migrador")
