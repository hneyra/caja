 ...
 * @param pagador a quien se le cobro, CONGELADO en el propio recibo (P5D). Hasta la separacion esto
 *     era un identificador del padron de `rentas` y el nombre se releia de alli; releerlo daba un
 *     duplicado distinto del original con el mismo numero
