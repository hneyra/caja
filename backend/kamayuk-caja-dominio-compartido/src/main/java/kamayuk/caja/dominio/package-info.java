 ...
 *
 * <p><b>Por que cuelga de {@code kamayuk.caja} y no de {@code kamayuk.caja.compartido}.</b> Para
 ...
 * regla de calculo y esta bloqueado por D-02a. {@link kamayuk.caja.dominio.Dinero} sabe sumar y
 * restar; no sabe cuanto se debe.
 *
 * <p>{@code @NullMarked}: todo es no nulo salvo lo marcado {@code @Nullable} (ARQ-04 §4).
 */
@org.jspecify.annotations.NullMarked
package kamayuk.caja.dominio;
