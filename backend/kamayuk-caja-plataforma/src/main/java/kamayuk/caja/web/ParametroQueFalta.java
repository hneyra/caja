 ...
 *
 * <p>{@code kamayuk.caja.web} vive en {@code kamayuk-caja-plataforma}, que no depende —ni debe— de
 * {@code kamayuk-caja-parametros}, que es un contexto acotado. Quien traduce la excepcion es el
