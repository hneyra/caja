 ...
 *
 * <p><b>Por que cuelga de {@code kamayuk.caja} y no de {@code kamayuk.caja.plataforma}</b>, aunque
 * viva en el mismo modulo Gradle: por el mismo motivo que {@code kamayuk.caja.dominio}. Para Spring
 ...
 * modulo compartido en {@code KamayukAplicacion}: no es un contexto acotado, y que cualquier
...
package kamayuk.caja.persistencia;
