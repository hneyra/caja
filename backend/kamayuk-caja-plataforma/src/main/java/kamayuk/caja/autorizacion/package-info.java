 ...
 *
 * <p>Los doce contextos declaran su acceso con {@link kamayuk.caja.autorizacion.RequiereAcceso},
 * asi que la anotacion y el enum tienen que estar en un modulo que todos puedan importar. Si
 * vivieran en {@code kamayuk-caja-seguridad}, cada contexto dependeria de el —lo que ARQ-01 admite—
 * pero {@code kamayuk-caja-seguridad} no podria aplicar las mismas convenciones sin depender de si
 * mismo.
 *
 * <p>De ahi el reparto: aqui el <b>contrato</b> —la anotacion, el enum y el puerto {@link
 * kamayuk.caja.autorizacion.ComprobadorDeAcceso}—, y en {@code kamayuk-caja-seguridad} la
