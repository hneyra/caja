...
class GuardiaDeAccesoTest {
    ...
    void sinPrivilegio403() throws Exception {
        ...
        MvcResult resultado = mvc.perform(get(Api.RAIZ + "/prueba/consulta")).andReturn();
    ...
    void sinFichaLoDice() throws Exception {
        ...
        MvcResult resultado = mvc.perform(get("/caja/api/v1/prueba/consulta")).andReturn();
    ...
    void conFichaSigueDiciendoElPrivilegio() throws Exception {
        ...
        assertThat(mvc.perform(get("/caja/api/v1/prueba/consulta")).andReturn().getResponse().getContentAsString())
    ...
    void elPrivilegioDelMetodoGana() throws Exception {
        ...
        mvc.perform(get(Api.RAIZ + "/prueba/alta")).andReturn();
    ...
    void sesionPropiaPasaSinComprobarElCatalogo() throws Exception {
        ...
        MvcResult resultado = mvc.perform(get(Api.RAIZ + "/prueba/sesion")).andReturn();
    ...
    void ciudadanoPasaSoloDesdeSuCadena() throws Exception {
        ...
        try {
            MvcResult resultado =
                    mvc.perform(get(SeguridadWeb.RAIZ_DEL_PORTAL + "/prueba")).andReturn();
    ...
    void conSoloLaAlternativaPasa() throws Exception {
        ...
        MvcResult resultado = mvc.perform(get(Api.RAIZ + "/prueba/dos-opciones")).andReturn();
    ...
    void laAlternativaNoRelajaElPrivilegio() throws Exception {
        ...
        mvc.perform(get(Api.RAIZ + "/prueba/dos-opciones")).andReturn();
    ...
    void sinAccesoDeclaradoSeDeniega() throws Exception {
        ...
        MvcResult resultado = mvc.perform(get(Api.RAIZ + "/prueba/sin-declarar")).andReturn();
    ...
    static class ControladorDePrueba {
        ...
        @GetMapping(Api.RAIZ + "/prueba/consulta")
        String consultar() {
            return "ok";
        }

        @GetMapping(Api.RAIZ + "/prueba/alta")
    ...
    static class ControladorSinDeclarar {
        ...
        @GetMapping(Api.RAIZ + "/prueba/sin-declarar")
        String sinDeclarar() {
            return "ok";
        }
    }
    ...
    static class ControladorDeDosOpciones {
        ...
        @GetMapping(Api.RAIZ + "/prueba/dos-opciones")
        String consultar() {
            return "ok";
        }
    }
    ...
    static class ControladorDeSesionPropia {
        ...
        @GetMapping(Api.RAIZ + "/prueba/sesion")
        String sesion() {
            return "ok";
        }
    }
    ...
    static class ControladorDelCiudadano {
        ...
        @GetMapping(SeguridadWeb.RAIZ_DEL_PORTAL + "/prueba")
        String situacion() {
            return "ok";
        }
    }
