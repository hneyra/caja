...
/**
 * Lo que contesto el otro sistema, leido de verdad y sin llevarse un secreto por delante (#95,
 * #96).
 *
 * <p>Las siete llevan {@code @Test}, y se dice porque <b>en la copia de `rentas` una no lo
 * lleva</b>: {@code elTopeYLaLinea} se quedo sin la anotacion alli, asi que la afirmacion del tope
 * no se ejecuta nunca. Se midio antes de copiar el archivo y no se copio el hueco. Aquella copia es
 * de aquel repositorio y no se toca desde aqui.
 */
...
class RespuestaAjenaTest {
    ...
    /** El cuerpo literal que `identidad` contesto en `stg` el 2026-09-11 (`rentas`#66). */
     ...
     * municipalidad, y el mensaje acaba en {@code pago_evento.ultimo_error}, que se guarda.
     */
    @Test
    ...
    void ningunSecretoViaja() {
        ...
        assertThat(contesto.cuerpo())
                .as("[esto acaba en un log y en una columna, y un token ahi es un incidente]")
