// kamayuk-caja-plataforma no es un contexto acotado: es la infraestructura tecnica que
...
//
// Vive fuera de kamayuk-caja-aplicacion porque ese modulo ensambla y nada mas (ADR-0003),
// y fuera de kamayuk-caja-dominio-compartido porque depende de Spring y el dominio no
...
dependencies {
    ...
    api(project(":kamayuk-caja-dominio-compartido"))
    ...
    // kamayuk.caja.web, y la usan los controladores de los doce contextos: por eso
    ...
    // actuator de produccion lo trae kamayuk-caja-aplicacion, que es quien lo despliega.
