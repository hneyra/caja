 ...
 *
 * Porque V8 **no dibuja ninguna pantalla de preferencias** —en `rentas` sus cuarenta estan
 * comparadas contra el artboard, y en `caja` cada hoja es un acceso del backend—: una pantalla de
 * preferencias en el arbol seria una hoja sin acceso, que es justo lo que esas guardas impiden. El menu de sesion **si** trae «Preferencias» —esta en el artboard, y hasta este
