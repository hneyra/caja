...
import { HOJA_DE_UI } from './tailwind.ts';
...
/**
 * La hoja de `@kamayuk/ui`, y no la del artboard de `rentas` (#74): `caja` no tiene artboard, y la
 * libreria escribe la misma regla —«`--tinta-4` NO ES COLOR DE TEXTO»— en la cabecera de la hoja
 * que se sirve. `losQueNoSonTexto` sabe leer las dos.
 */
const HOJA_DEL_ARTBOARD = readFileSync(HOJA_DE_UI, 'utf8');
