...
/**
 * Una raiz de frontend que no existe, con la disposicion de la de verdad: `…/caja/frontend`,
 * para que `../../kamayuk-lib` caiga al lado de «caja» y no en cualquier sitio.
 */
const RAIZ_SIN_HERMANO = join(tmpdir(), 'kamayuk-ws-de-mentira', 'caja', 'frontend');
