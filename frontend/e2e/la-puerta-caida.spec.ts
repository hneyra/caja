 ...
 * body.innerText  -> ""
 * body.innerHTML  -> ""
 * peticion fallida: http://localhost:8180/realms/kamayuk/protocol/openid-connect/auth?...
 ...
 * por hecho que el 8180 esta libre haria una prueba que se pone roja por tener la plataforma
...
test('la puerta que NO contesta: la aplicacion monta y dice quien fallo y en que URL', async ({
  ...
  expect(texto).toContain('http://localhost:8180/realms/kamayuk');
