...
test('la BARRA DE DESPLAZAMIENTO —que pinta el navegador— cambia con el modo y no con la identidad', async ({
  ...
  // Hueco corto a proposito: el cuerpo de `cierre-caja` tiene que desbordar para que haya barra, y es
  // la pantalla mas larga de la ventanilla —tres bloques, tres tablas—. Los controles que en `rentas`
  // se midieron para descartarlos aqui no hay ni uno: la ventanilla solo lee (ADR-0040).
