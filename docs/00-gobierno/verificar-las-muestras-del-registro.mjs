/* Comprueba que verificar-fila-del-registro.mjs muerde, y que no muerde de mas.
   ...
   **nombre el issue y su motivo**: rechazar por el motivo equivocado seria pasar por
   ...
   frase decia «ocho, cinco y tres», y cada muestra nueva la habria vuelto falsa.
...
const CASOS = [
  ...
  },
  {
    ...
    cuerpo: 'Closes #711',
    archivos: ['frontend/src/modulos/caja/Pantalla.tsx'],
  ...
  },
  {
    ...
    cuerpo: 'Closes #711. Un servicio mas en el compose.',
  ...
  },
  {
    ...
    archivos: [
      ...
      'backend/kamayuk-caja/src/test/java/kamayuk/caja/AlgoTest.java',
    ],
    anadido: '',
    esperado: 'verde',
  },
